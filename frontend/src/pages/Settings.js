            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <div
                style={{
                  ...
                  border: `2px solid ${darkMode ? 'var(--primary)' : 'var(--border)'}`,
                  textAlign: 'center',
                  fontSize: 13,
                  cursor: 'pointer',
                }}
              ...
              <div
                style={{
                  ...
                  padding: 16,
                  borderRadius: 10,
                  background: darkMode ? '#1a202c' : '#f0f4f8',
                  border: `2px solid ${darkMode ? 'var(--primary)' : 'var(--border)'}`,
                  textAlign: 'center',
                  fontSize: 13,
                  cursor: 'pointer',
      ...
      {tab === 'backup' && (
        ...
        >
          <div className="card">
            ...
            >
              Download all your expense data as JSON file.
            </p>
            <div className="alert alert-info" style={{ marginBottom: 16 }}>
              <span>ℹ️</span>
              <div style={{ fontSize: 12 }}>
                Backup includes all expenses. Keep it safe for data recovery.
              </div>
            </div>
            <button className="btn btn-primary btn-full" onClick={handleBackup}>
              📥 Download Backup
            </button>
          </div>
          ...
          <div className="card">
            ...
            {restoreData && (
              <div className="alert alert-success" style={{ marginBottom: 12 }}>
                ...
                <div style={{ fontSize: 12 }}>
                  <div>
                    <strong>{restoreData.totalRecords}</strong> records ready
                  </div>
                  <div>Exported by: {restoreData.user?.name}</div>
                  <div>
                    Date:{' '}
                    {new Date(restoreData.exportedAt).toLocaleDateString()}
                  </div>
                </div>
              </div>
            )}
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: 'var(--danger)' }}>
                  Warning: deletes all current expenses!
                </div>
              </div>
            </div>
            <button
